...
- Start Microsoft 365 Developer Proxy specifying the path to one of the mock files, eg. `m365proxy --config-file microsoft-graph-rate-limiting.json`
...
![](https://m365-visitor-stats.azurewebsites.net/SamplesGallery/pnp-m365proxy-microsoft-graph-rate-limiting)
