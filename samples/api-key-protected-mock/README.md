...
-------|----|--------
1.6|July 1, 2026|Updated to Dev Proxy v3.1.0
...
* Get the sample:
  - Download just this sample:
      ...
      ```bash
      npx gitload-cli https://github.com/pnp/proxy-samples/tree/main/samples/api-key-protected-mock
      ```

    or

  - [Download as a .ZIP file](https://pnp.github.io/download-partial/?url=https://github.com/pnp/proxy-samples/tree/main/samples/api-key-protected-mock) and unzip it, or
