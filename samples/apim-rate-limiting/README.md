...
- Get the sample:
  - Download just this sample:
      ...
      ```bash
      npx gitload-cli https://github.com/pnp/proxy-samples/tree/main/samples/apim-rate-limiting
      ```

    or

  - [Download as a .ZIP file](https://pnp.github.io/download-partial/?url=https://github.com/pnp/proxy-samples/tree/main/samples/apim-rate-limiting) and unzip it, or
