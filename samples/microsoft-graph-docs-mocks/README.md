...
-------|----|--------
1.25|July 1, 2026|Updated to Dev Proxy v3.1.0
1.24|June 17, 2026|Updated to Dev Proxy v3.0.1
1.14|May 30, 2026|Updated to Dev Proxy v3.0.0
1.13|March 26, 2026|Updated to Dev Proxy v2.3.0
1.12|March 11, 2026|Updated to Dev Proxy v2.2.0
1.11|February 4, 2026|Updated to Dev Proxy v2.1.0
1.10|January 18, 2026|Moved config files to .devproxy folder
...
- Get the sample:
  - Download just this sample:
      ...
      ```bash
      npx gitload-cli https://github.com/pnp/proxy-samples/tree/main/samples/microsoft-graph-docs-mocks
      ```

    or

  - [Download as a .ZIP file](https://pnp.github.io/download-partial/?url=https://github.com/pnp/proxy-samples/tree/main/samples/microsoft-graph-docs-mocks) and unzip it, or
